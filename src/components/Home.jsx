import { AiFillFileText, AiFillMessage, AiFillYoutube, AiFillProject, AiFillRightSquare } from "react-icons/ai";
    ...
    <>
      ...
      <Container fluid className="home-wrapper ">
        ...
        <div className="home-right mt-3 animate__animated animate__fadeIn animate__slower">
          <div className="row">
            <div className="col-12 col-md-12 col-lg-5 me-4">
          ...
          <div className="row mt-4">
            ...
            <div className="youtube-wrapper border rounded px-4 py-3 mt-3">
              <h1><AiFillProject /></h1>
              <div className="ms-5 mt-2">
                <h5>Pinned Projects</h5>
                <p className="text-secondary"> MidoList  - A Simple To-Do List Web App using React + Redux</p>
                <a target={'_blank'} href="https://midolist.netlify.app" className="btn btn-dark w-100"><AiFillRightSquare />&nbsp;Open Site &nbsp;</a>
              </div>
            </div>
          </div>
          <div className="row mt-4">
