import { AiFillFileText, AiFillMessage, AiFillYoutube, AiFillProject, AiFillRightSquare, AiFillProfile } from "react-icons/ai";
    ...
    <>
      ...
      <Container fluid className="home-wrapper">
        <div className="home-left animate__animated animate__fadeInLeft mb-5 mt-3">
          ...
          <h3 className="mb-5 fw-light">A Computer Enthusiast</h3>
          <hr />

          <div className="row">
            <div className="col">
              <Link className="btn-download text-center rounded-3" to={CVDoc} target="_blank" rel="noreferrer" download><AiFillFileText className="mt-1" />&nbsp;&nbsp;Download CV</Link>
            </div>
            <div className="col">
              <a href="contact" className=" btn-download text-center rounded-3"> <AiFillMessage className="mt-1" /> &nbsp; Get in Touch&nbsp;</a>
            </div>
          </div>
        </div>
        <div className="home-right mt-3 animate__animated animate__fadeIn animate__slower">
          <div className="row">
            <div className="col-12 col-md-6 col-lg-5 me-4">
              <img className="home-image rounded-3 shadow img-fluid mt-3" src={image} onMouseEnter={setAvatarReal} onMouseLeave={setAvatarAnimation} alt="Avatar" />
            ...
            <div className="col-12 col-md-6 mt-3">
              <div className="row">
                ...
                <p className="card-text text-secondary">Open the other pages of this portfolio.</p>
              </div>
              <div className="row mt-3">
                <a href="about" className="btn btn-outline-light w-100 mt-1 fs-4">About</a>
              </div>
              <div className="row mt-2">
                <a href="project" className="btn btn-outline-light w-100 mt-1 fs-4">Project</a>
              </div>
              <div className="row mt-2">
                <a href="contact" className="btn btn-outline-light w-100 mt-1 fs-4">Contact</a>
              </div>
          ...
          <div className="row mt-4">
            ...
            <div className="card-wrapper border rounded px-4 py-3 mt-3">
              ...
              <div className="ms-5 mt-2">
                ...
                <p className="text-secondary"> MidoList  - A Simple To-Do List Web App using React + Redux</p>
                <a target={'_blank'} href="https://midolist.netlify.app" className="btn btn-dark"><AiFillRightSquare />&nbsp;Open Site &nbsp;</a>
              </div>
            </div>
          </div>
          <div className="row mt-4">
            <div className="card-wrapper border rounded px-4 py-3">
              ...
              <div className="ms-5 mt-2">
                ...
                <a target={'_black'} href="https://www.youtube.com/channel/UCV4p9jOV1IzGim2GbexAFSQ" className="btn btn-dark"><AiFillRightSquare />&nbsp;Open Site &nbsp;</a>
              </div>
            </div>
          </div>
          <hr className="mt-5" />
          ...
          <div className="row mt-4" >
            ...
            <div className="card-wrapper mt-4 border rounded px-4 py-3 "style={{marginBottom: '100px'}}>
              <div className="row">
                <div className="d-flex flex-row justify-content-center align-items-center">
